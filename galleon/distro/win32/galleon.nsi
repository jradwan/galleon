...
; Download the JRE and JAI installers and place them in the paths indicated below.
...
!define PRODUCT_CONFIGURE '"$SYSDIR\javaw.exe" -classpath galleon.jar;log4j.jar;xml-apis.jar;xercesImpl.jar;js.jar;jdom.jar;commons-lang.jar;mytunes.jar;forms.jar;looks.jar;silib.jar;jcaching.jar;org.mortbay.jetty.jar;commons-betwixt.jar org.lnicholls.galleon.gui.Galleon'
!define PRODUCT_BUILD_DIR "d:\galleon\build"

!define JRE_VERSION "1.5.0"
!define JRE_URL "d:\download\jdk-1_5_0-windows-i586.exe"
!define JRE_PATH $R0
!define JAI_URL "d:\download\jai-1_1_2-lib-windows-i586-jre.exe"
!define TEMP $R1
!define TEMP2 $R2
!define TEMP3 $R3
!define TEMP4 $R4
...
; Determine if the JAI is already installed
Page custom CheckInstalledJAI
...
; Install the JAI if not already installed
Section "JAI" jai
  StrCmp ${DOWNLOAD_JAI_FLAG} "NoDownload" End

  DetailPrint "Starting the JAI installation"
  File /oname=$TEMP\jai_setup.exe ${JAI_URL}
  DetailPrint "Launching JAI setup"
  ExecWait "$TEMP\jai_setup.exe" $0
  BringToFront
  DetailPrint "Setup finished"
  Delete "$TEMP\jai_setup.exe"
  StrCmp $0 "0" InstallVerif 0
  Push "The JAI setup has been abnormally interrupted."
  Goto ExitInstallJAI

InstallVerif:
  DetailPrint "Checking the JAI Setup's outcome"
  Call DetectJAI
  Pop $0
  StrCmp $0 "OK" End 0
  Push "The JAI setup failed"
  Goto ExitInstallJAI
...
Section -installGalleon SEC01
  ...
  File ${PRODUCT_BUILD_DIR}\bin\install.bat
  File ${PRODUCT_BUILD_DIR}\bin\run.cmd
  File ${PRODUCT_BUILD_DIR}\bin\uninstall.bat
...
CopyFiles:
  ...
  File ${PRODUCT_BUILD_DIR}\images\couldnotconnect.mp3
  File ${PRODUCT_BUILD_DIR}\images\galleon.ico
  File ${PRODUCT_BUILD_DIR}\images\cross.jpg

  DetailPrint "Installing Galleon libraries"
  SetOutPath "$INSTDIR\lib"
  File /oname=a.j ${PRODUCT_BUILD_DIR}\lib\activation.jar
  File /oname=b.j ${PRODUCT_BUILD_DIR}\lib\calpahtml.jar
  File /oname=c.j ${PRODUCT_BUILD_DIR}\lib\commons-beanutils.jar
  File /oname=d.j ${PRODUCT_BUILD_DIR}\lib\commons-betwixt.jar
  File /oname=e.j ${PRODUCT_BUILD_DIR}\lib\commons-collections.jar
  File /oname=f.j ${PRODUCT_BUILD_DIR}\lib\commons-digester.jar
  File /oname=g.j ${PRODUCT_BUILD_DIR}\lib\commons-lang.jar
  File /oname=h.j ${PRODUCT_BUILD_DIR}\lib\commons-logging.jar
  File /oname=i.j ${PRODUCT_BUILD_DIR}\lib\commons-net.jar
  File /oname=j.j ${PRODUCT_BUILD_DIR}\lib\concurrent.jar
  File /oname=font.properties ${PRODUCT_BUILD_DIR}\lib\font.properties
  File /oname=k.j ${PRODUCT_BUILD_DIR}\lib\forms.jar
  File /oname=l.j ${PRODUCT_BUILD_DIR}\lib\httpunit.jar
  File /oname=m.j ${PRODUCT_BUILD_DIR}\lib\imageloader.jar
  File /oname=image_decode.dll ${PRODUCT_BUILD_DIR}\lib\image_decode.dll
  File /oname=n.j ${PRODUCT_BUILD_DIR}\lib\informa.jar
  File /oname=o.j ${PRODUCT_BUILD_DIR}\lib\jasper-runtime.jar
  File /oname=galleon.jar ${PRODUCT_BUILD_DIR}\lib\javahmo.jar
  File /oname=p.j ${PRODUCT_BUILD_DIR}\lib\javax.servlet.jar
  File /oname=q.j ${PRODUCT_BUILD_DIR}\lib\jawin.jar
  File /oname=jawin.dll ${PRODUCT_BUILD_DIR}\lib\jawin.dll
  File /oname=r.j ${PRODUCT_BUILD_DIR}\lib\jcaching.jar
  File /oname=s.j ${PRODUCT_BUILD_DIR}\lib\jdai.jar
  File /oname=t.j ${PRODUCT_BUILD_DIR}\lib\jdom.jar
  File /oname=u.j ${PRODUCT_BUILD_DIR}\lib\jicyshout.jar
  File /oname=v.j ${PRODUCT_BUILD_DIR}\lib\jiu.jar
  File /oname=w.j ${PRODUCT_BUILD_DIR}\lib\js.jar
  File /oname=jshortcut.dll ${PRODUCT_BUILD_DIR}\lib\jshortcut.dll
  File /oname=x.j ${PRODUCT_BUILD_DIR}\lib\jshortcut.jar
  File /oname=y.j ${PRODUCT_BUILD_DIR}\lib\log4j.jar
  File /oname=z.j ${PRODUCT_BUILD_DIR}\lib\looks.jar
  File /oname=1.j ${PRODUCT_BUILD_DIR}\lib\mail.jar
  File /oname=2.j ${PRODUCT_BUILD_DIR}\lib\MHS.jar
  File /oname=3.j ${PRODUCT_BUILD_DIR}\lib\mp3dings.jar
  File /oname=4.j ${PRODUCT_BUILD_DIR}\lib\mytunes.jar
  File /oname=5.j ${PRODUCT_BUILD_DIR}\lib\newsgreed.jar
  File /oname=6.j ${PRODUCT_BUILD_DIR}\lib\org.mortbay.jetty.jar
  File /oname=7.j ${PRODUCT_BUILD_DIR}\lib\pja.jar
  File /oname=silib.dll ${PRODUCT_BUILD_DIR}\lib\silib.dll
  File /oname=8.j ${PRODUCT_BUILD_DIR}\lib\silib.jar
  File /oname=9.j ${PRODUCT_BUILD_DIR}\lib\Tidy.jar
  File /oname=Wrapper.dll ${PRODUCT_BUILD_DIR}\lib\Wrapper.dll
  File /oname=0.j ${PRODUCT_BUILD_DIR}\lib\wrapper.jar
  File /oname=x1.j ${PRODUCT_BUILD_DIR}\lib\xercesImpl.jar
  File /oname=x2.j ${PRODUCT_BUILD_DIR}\lib\xml-apis.jar
  
  DetailPrint "Installing Galleon plugins"
  SetOutPath "$INSTDIR\plugins"
  File ${PRODUCT_BUILD_DIR}\plugins\desktop.jar
  File ${PRODUCT_BUILD_DIR}\plugins\email.jar
  ;File ${PRODUCT_BUILD_DIR}\plugins\gallery.jar
  File ${PRODUCT_BUILD_DIR}\plugins\games.jar
  File ${PRODUCT_BUILD_DIR}\plugins\imageOrganizer.jar
  File ${PRODUCT_BUILD_DIR}\plugins\images.jar
  File ${PRODUCT_BUILD_DIR}\plugins\internet.jar
  File ${PRODUCT_BUILD_DIR}\plugins\iTunes.jar
  File ${PRODUCT_BUILD_DIR}\plugins\jukebox.jar
  File ${PRODUCT_BUILD_DIR}\plugins\movies.jar
  File ${PRODUCT_BUILD_DIR}\plugins\music.jar
  File ${PRODUCT_BUILD_DIR}\plugins\nntp.jar
  File ${PRODUCT_BUILD_DIR}\plugins\organizer.jar
  File ${PRODUCT_BUILD_DIR}\plugins\playlists.jar
  File ${PRODUCT_BUILD_DIR}\plugins\rss.jar
  File ${PRODUCT_BUILD_DIR}\plugins\shoutcast.jar
  File ${PRODUCT_BUILD_DIR}\plugins\stocks.jar
  File ${PRODUCT_BUILD_DIR}\plugins\weather.jar
  File ${PRODUCT_BUILD_DIR}\plugins\web.jar
...
ClassPath:
  ...
  SetOutPath "$INSTDIR\lib"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Configure.lnk" "$SYSDIR\javaw.exe" '-classpath galleon.jar;a.j;b.j;c.j;d.j;e.j;f.j;g.j;h.j;i.j;j.j;k.j;l.j;m.j;n.j;o.j;p.j;q.j;r.j;s.j;t.j;u.j;v.j;w.j;x.j;y.j;z.j;1.j;2.j;3.j;4.j;5.j;6.j;7.j;8.j;9.j;0.j;x1.j;x2.j org.lnicholls.galleon.gui.Galleon' "$INSTDIR\images\galleon.ico"
...
RemoveTiVoBeacon:
  ...
  nsSCM::Remove /NOUNLOAD "TivoBeacon"
  Pop $6 ; return error/success
...
InstallService:
  ...
  nsSCM::Install /NOUNLOAD "${PRODUCT_NAME}" "${PRODUCT_NAME} TiVo TCM" 272 2 '"$INSTDIR\bin\Wrapper.exe" -s "$INSTDIR\conf\wrapper.conf"' "" ""
  Pop $3 ; return error/success
...
; Determine if JAI is already installed
Function CheckInstalledJAI
  Call DetectJAI
  Pop ${TEMP4}
  StrCmp ${TEMP4} "OK" NoDownloadJAI

  StrCpy ${DOWNLOAD_JAI_FLAG} "Download"
  Return

NoDownloadJAI:
  StrCpy ${DOWNLOAD_JAI_FLAG} "NoDownload"
  Return
...
; Find the JAI files
Function DetectJAI
  IfFileExists "${JRE_PATH}\lib\ext\jai_core.jar"  FoundNew
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${jai} "The Java Advanced Imaging version 1.1.2 is required for Galleon to run. It will only be installed if it is not detected on you system."
