...
!define PRODUCT_VERSION "0.0.0 beta 10"
...
ExitInstallJMF:
  Pop $2
;  MessageBox MB_OK "The setup is about to be interrupted for the following reason : $2"
  MessageBox MB_YESNO "The JMF setup appeared to have failed for the following reason : $2. Would you like to continue anyway?" IDYES End
  Quit
End:
