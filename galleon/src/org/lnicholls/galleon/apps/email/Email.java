...
public class Email extends DefaultApplication {
    ...
    protected void init(Context context) {
        ...
        EmailConfiguration emailConfiguration = (EmailConfiguration) ((EmailFactory) context.factory).getAppContext()
                .getConfiguration();

        if (emailConfiguration.getAccounts().size() == 1) {
            Account account = (Account) emailConfiguration.getAccounts().get(0);
            List mail = (List) ((EmailFactory) context.factory).mAccounts.get(account.getName());
    ...
    public class EmailMenuScreen extends DefaultMenuScreen {
        public EmailMenuScreen(Email app) {
            ...
            EmailConfiguration emailConfiguration = (EmailConfiguration) ((EmailFactory) context.factory)
            ...
            for (int i = 0; i < feedArray.length; i++) {
                ...
                List stories = (List) ((EmailFactory) context.factory).mAccounts.get(account.getName());
                if (stories != null)
    ...
    public class EmailScreen extends DefaultScreen {
        ...
        public EmailScreen(Email app, EmailItem item) {
            ...
            BText fromText = new BText(normal, BORDER_LEFT, start, BODY_WIDTH, 30);
            ...
            BText dateText = new BText(normal, BORDER_LEFT, start, BODY_WIDTH, 20);
            ...
            mScrollText = new ScrollText(normal, SAFE_TITLE_H, start, BODY_WIDTH - 10, height - 2 * SAFE_TITLE_V - 193,
                    cleanHTML(item.getBody()));

            /*
             * mList = new DefaultOptionList(this.normal, SAFE_TITLE_H, (height - SAFE_TITLE_V) - 40, (width -
