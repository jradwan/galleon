...
public class HDPhotos {
    ...
    public static class HDPhotosFactory extends AppFactory {
        ...
        public void initFactory(String appClassName, ClassLoader loader, IArgumentList args) {
            ...
            // initialize the factory arguments, but skip the rest, don't call super
            this.init(args);
        }
...
//                    cmd.add("-Xdebug");
//                    cmd.add("-Xrunjdwp:transport=dt_socket,address=8000,server=y,suspend=n");
                    ...
                    try {
                        process = Runtime.getRuntime().exec(
                                cmd.toArray(new String[cmd.size()]), null, installDir);
                ...
                if (process != null) {
                    ...
                    //exit with calypso option will close it when the calypso server disconnects
                    process.destroy();
                    process = null;
                }
            }
