...
public class Weather extends BApplication {
    ...
    public class WeatherMenuScreen extends DefaultScreen {
        ...
        public class TGList extends BList {
            ...
            protected void createRow(BView parent, int index) {
                ...
                name.setValue("Current Conditions");
            }
    ...
    public class CurrentConditionsScreen extends DefaultScreen {
        ...
        private final int text_width = width - border_left - (SAFE_TITLE_H + 32);
        ...
        private void updateText() {
            ...
            uvIndexText.setValue(mWeatherData.getCurrentConditions().getUltraVioletIndex()+" "+mWeatherData.getCurrentConditions().getUltraVioletDescription());
            windText.setValue("From "+mWeatherData.getCurrentConditions().getWindDescription()+" at "+mWeatherData.getCurrentConditions().getWindSpeed()+ " "+mWeatherData.getSpeedUnit());
            humidityText.setValue(mWeatherData.getCurrentConditions().getHumidity()+"%");
            pressureText.setValue(mWeatherData.getCurrentConditions().getBarometricPressure()+" "+mWeatherData.getPressureUnit()+".");
            dewPointText.setValue(mWeatherData.getCurrentConditions().getDewPoint()+"\u00BA"+mWeatherData.getTemperatureUnit());
            visibilityText.setValue(mWeatherData.getCurrentConditions().getVisibility()+" "+mWeatherData.getDistanceUnit()+".");
        }
