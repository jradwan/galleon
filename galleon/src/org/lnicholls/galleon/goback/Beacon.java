...
public class Beacon implements Constants {
    ...
    public boolean isValid() {
        return mTivoConnect != null && mMethod != null && mPlatform != null && mMachine != null && mIdentity != null
                && mSWVersion != null;
    }
    ...
    public String toString() {
        ...
        synchronized (buffer) {
            ...
            if (mMethod != null)
                buffer.append(NAME_METHOD + "=" + mMethod + '\n');
            if (mPlatform != null)
                buffer.append(NAME_PLATFORM + "=" + mPlatform + '\n');
            buffer.append(NAME_MACHINE + "=" + mMachine + '\n');
            buffer.append(NAME_IDENTIFY + "=" + mIdentity + '\n');
            if (mServices != null)
                buffer.append(NAME_SERVICES + "=" + mServices + '\n');
            if (mSWVersion != null)
                buffer.append(NAME_SWVERSION + "=" + mSWVersion + '\n');
        }
