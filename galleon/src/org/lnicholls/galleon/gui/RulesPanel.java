...
public class RulesPanel extends JPanel implements ActionListener, KeyListener {
        ...
        private static final ColumnData mColumns[] = { new ColumnData("Criteria", 50, JLabel.LEFT),
                new ColumnData("Comparison", 50, JLabel.LEFT), new ColumnData("Value", 200, JLabel.LEFT),
        ...
        public RulesPanel(RecordedPanel recordedPanel) {
            ...
            mCriteriaField.setToolTipText("Select a criteria for automatic downloads of TiVo recordings");
            mCriteriaField.addItem(new ReloadWrapper("Title", Rule.CRITERIA_TITLE));
            mCriteriaField.addItem(new ReloadWrapper("Description", Rule.CRITERIA_DESCRIPTION));
            mCriteriaField.addItem(new ReloadWrapper("Channel", Rule.CRITERIA_CHANNEL));
            mCriteriaField.addItem(new ReloadWrapper("Station", Rule.CRITERIA_STATION));
            mCriteriaField.addItem(new ReloadWrapper("Rating", Rule.CRITERIA_RATING));
            mCriteriaField.addItem(new ReloadWrapper("Quality", Rule.CRITERIA_QUALITY));
            ...
            mComparisonField.addItem(new ReloadWrapper("Equals", Rule.COMPARISON_EQUALS));
            mComparisonField.addItem(new ReloadWrapper("Starts With", Rule.COMPARISON_STARTS_WITH));
            mComparisonField.addItem(new ReloadWrapper("Ends With", Rule.COMPARISON_ENDS_WITH));
            mComparisonField.addItem(new ReloadWrapper("More Than", Rule.COMPARISON_MORE_THAN));
            mComparisonField.addItem(new ReloadWrapper("Less Than", Rule.COMPARISON_LESS_THAN));
            mValueField = new JTextField(30);
            mValueField.setToolTipText("Enter a value for the comparison and criteria. Empty for all");
            ...
            FormLayout layout = new FormLayout("left:pref, 3dlu, left:pref, right:pref:grow ", 
                    "pref, " + //criteria
            ...
            builder.add(mDownloadField, cc.xy(3, 7));
                ...
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    if (!lsm.isSelectionEmpty()) {
                        if (!mUpdating) {
                            ...
                            defaultCombo(mCriteriaField, (String) model.getValue(selectedRow, 0));
                            defaultCombo(mComparisonField, (String) model.getValue(selectedRow, 1));
                            mValueField.setText((String) model.getValue(selectedRow, 2));
                            mDownloadField.setSelected(((Boolean) model.getValue(selectedRow, 3)).booleanValue());
                        }
        ...
        public void actionPerformed(ActionEvent e) {
            if ("add".equals(e.getActionCommand())) {
                ...
                try {
                    ...
                    model.setValueAt(new Boolean(mDownloadField.isSelected()), nextRow, 3);
                } catch (Exception ex) {
                ...
                try {
                    ...
                    if (selectedRow != -1) {
                        ...
                        values[3] = new Boolean(mDownloadField.isSelected());
        ...
        class ShowTableData extends AbstractTableModel {
            ...
            class ColumnListener extends MouseAdapter {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    Collections.sort(mRules, new RuleComparator(modelIndex, mSortAsc));
            ...
            class RuleComparator implements Comparator {
                ...
                public int compare(Object o1, Object o2) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        result = rule1.getComparison().compareTo(rule2.getComparison());
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        result = download1.toString().compareTo(download2.toString());
                        break;
                    }
