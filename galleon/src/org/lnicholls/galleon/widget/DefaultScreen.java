...
public class DefaultScreen extends BScreen {
    ...
    public DefaultScreen(DefaultApplication app, Color color) {

        this(app, "background.jpg", color);
    ...
    public DefaultScreen(DefaultApplication app, String background, Color color) {

        this(app, background, null, false, color);
    ...
    public DefaultScreen(DefaultApplication app, boolean hints, Color color) {
    	this(app, null, hints, color);
    }
    ...
    public DefaultScreen(DefaultApplication app, String title, boolean hints, Color color) {
    	this(app, "background.jpg", title, hints, color);
    }


    public DefaultScreen(DefaultApplication app, String background, String title, boolean hints) {
    	this(app, background, title, hints, Color.YELLOW);
    }


    public DefaultScreen(DefaultApplication app, String background, String title, boolean hints, Color color) {
    ...
    public void setTitle(String value) {
    	setTitle(value, Color.yellow);
    }


    public void setTitle(String value, Color color) {
        ...
        if (value != null && value.length() > 0) {
            ...
            if (mTitle == null) {
                ...
                mTitle.setFont("system-40-bold.font");

            }

            mTitle.setValue(value.toUpperCase());
